...
AKGHealthPickUp_C__pf2132744816::AKGHealthPickUp_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Sphere__pf = CreateDefaultSubobject<USphereComponent>(TEXT("Sphere"));
	bpv__P_Health__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("P_Health"));
	...
	bpv__P_Health__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__P_Health__pf->AttachToComponent(bpv__Sphere__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__P_Health__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AKGHealthPickUp_C__pf2132744816::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__P_Health__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__P_Health__pf), false, 0));
	bpv__HealthOffering__pf = 50.000000f;
...
void AKGHealthPickUp_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__P_Health__pf)
	{
		bpv__P_Health__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AKGHealthPickUp_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AKGHealthPickUp_C__pf2132744816::bpf__ExecuteUbergraph_KGHealthPickUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				bpfv__CallFunc_GetObjectClass_ReturnValue__pf = UGameplayStatics::GetObjectClass(b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf);
				float  __Local__7 = 0.000000;
				float  __Local__8 = 0.000000;
				bpfv__CallFunc_EqualEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::EqualEqual_FloatFloat(((::IsValid(bpfv__CallFunc_GetObjectClass_ReturnValue__pf)) ? (GetDefaultValueSafe<AKGCharacterBase_C__pf2132744816>(bpfv__CallFunc_GetObjectClass_ReturnValue__pf)->bpv__Health__pf) : (__Local__7)), ((::IsValid(b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf)) ? (b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf->bpv__Health__pf) : (__Local__8)));
		...
		case 5:
			{
				bpfv__CallFunc_GetObjectClass_ReturnValue__pf = UGameplayStatics::GetObjectClass(b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf);
				float  __Local__9 = 0.000000;
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(((::IsValid(b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf)) ? (b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf->bpv__Health__pf) : (__Local__9)), bpv__HealthOffering__pf);
				float  __Local__10 = 0.000000;
				bpfv__CallFunc_FMin_ReturnValue__pf = UKismetMathLibrary::FMin(bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf, ((::IsValid(bpfv__CallFunc_GetObjectClass_ReturnValue__pf)) ? (GetDefaultValueSafe<AKGCharacterBase_C__pf2132744816>(bpfv__CallFunc_GetObjectClass_ReturnValue__pf)->bpv__Health__pf) : (__Local__10)));
				if(::IsValid(b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf))
				{
					b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf->bpv__Health__pf = bpfv__CallFunc_FMin_ReturnValue__pf;
				}
				__CurrentState = 1;
				break;
			}
...
void AKGHealthPickUp_C__pf2132744816::bpf__ReceiveActorBeginOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_KGHealthPickUp__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AKGHealthPickUp_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AKGHealthPickUp_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AKGHealthPickUp_C__pf2132744816
{
	FRegisterHelper__AKGHealthPickUp_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/KGHealthPickUp"), &AKGHealthPickUp_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AKGHealthPickUp_C__pf2132744816 Instance;
};
FRegisterHelper__AKGHealthPickUp_C__pf2132744816 FRegisterHelper__AKGHealthPickUp_C__pf2132744816::Instance;
