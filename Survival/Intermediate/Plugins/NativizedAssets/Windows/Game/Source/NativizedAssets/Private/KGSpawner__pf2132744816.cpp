...
#include "KGSpawner__pf2132744816.h"
...
AKGSpawner_C__pf2132744816::AKGSpawner_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__RespawnDelay__pf = 5.000000f;
	bpv__ActorToSpawn__pf = AKGHealthPickUp_C__pf2132744816::StaticClass();
...
void AKGSpawner_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AKGSpawner_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AKGSpawner_C__pf2132744816::bpf__ExecuteUbergraph_KGSpawner__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, bpv__ActorToSpawn__pf, b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::Undefined, ((AActor*)nullptr));
	b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, b0l__CallFunc_GetTransform_ReturnValue__pf);
	b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("BeginRespawnCountdown")));
	if(::IsValid(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf))
	{
		bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->OnDestroyed.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate__pf);
	}
	return; //KCST_EndOfThread
}
void AKGSpawner_C__pf2132744816::bpf__ExecuteUbergraph_KGSpawner__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 5);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::Delay(this, bpv__RespawnDelay__pf, FLatentActionInfo(-1, -1938983398, TEXT("ExecuteUbergraph_KGSpawner"), this));
	return; //KCST_EndOfThread
}
void AKGSpawner_C__pf2132744816::bpf__BeginRespawnCountdown__pf(AActor* bpp__DestroyedActor__pf)
{
	b0l__K2Node_CustomEvent_DestroyedActor__pf = bpp__DestroyedActor__pf;
	bpf__ExecuteUbergraph_KGSpawner__pf_1(5);
}
void AKGSpawner_C__pf2132744816::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_KGSpawner__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void AKGSpawner_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AKGSpawner_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AKGSpawner_C__pf2132744816
{
	FRegisterHelper__AKGSpawner_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/KGSpawner"), &AKGSpawner_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AKGSpawner_C__pf2132744816 Instance;
};
FRegisterHelper__AKGSpawner_C__pf2132744816 FRegisterHelper__AKGSpawner_C__pf2132744816::Instance;
