...
UUIHealthBar_C__pf2132744816::UUIHealthBar_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__ProgressBar_36__pf = nullptr;
	bpv__DefaultHealth__pf = 100.000000f;
	bpv__OwningxKnight__pfT = nullptr;
	bHasScriptImplementedTick = false;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UUIHealthBar_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UUIHealthBar_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__3->LayoutData.Offsets.Bottom = 5.000000f;
	...
	auto __Local__4 = NewObject<UProgressBar>(__Local__0, TEXT("ProgressBar_36"), (EObjectFlags)0x00280008);
	...
	__Local__5 = FLinearColor(1.000000, 0.081420, 0.000000, 1.000000);
	__Local__4->Percent = 0.500000f;
	__Local__4->FillColorAndOpacity = FLinearColor(0.040045, 1.000000, 0.000000, 1.000000);
...
PRAGMA_ENABLE_OPTIMIZATION
void UUIHealthBar_C__pf2132744816::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__6;
	SlotNames.Append(__Local__6);
}
void UUIHealthBar_C__pf2132744816::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__7;
	TArray<FDelegateRuntimeBinding>  __Local__8;
	__Local__8.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__8.GetData(), 1);
	auto& __Local__9 = __Local__8[0];
	__Local__9.ObjectName = FString(TEXT("ProgressBar_36"));
	__Local__9.PropertyName = FName(TEXT("Percent"));
	__Local__9.FunctionName = FName(TEXT("GetPercent_0"));
	auto& __Local__10 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__9.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__10 = TArray<FPropertyPathSegment> ();
	__Local__10.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__10.GetData(), 1);
	auto& __Local__11 = __Local__10[0];
	__Local__11.Name = FName(TEXT("GetPercent_0"));
	__Local__9.Kind = EBindingKind::Function;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UUIHealthBar_C__pf2132744816::StaticClass())->MiscConvertedSubobjects[0]), __Local__7, __Local__8);
}
void UUIHealthBar_C__pf2132744816::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UUIHealthBar_C__pf2132744816::bpf__ExecuteUbergraph_UIHealthBar__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpv__OwningxKnight__pfT = b0l__K2Node_CustomEvent_OwningKnight__pf;
	float  __Local__12 = 0.000000;
	bpv__DefaultHealth__pf = ((::IsValid(b0l__K2Node_CustomEvent_OwningKnight__pf)) ? (b0l__K2Node_CustomEvent_OwningKnight__pf->bpv__Health__pf) : (__Local__12));
	return; // KCST_GotoReturn
}
void UUIHealthBar_C__pf2132744816::bpf__SetOwningKnightCharacter__pf(const AKGCharacterBase_C__pf2132744816* bpp__OwningKnight__pf__const)
{
	typedef AKGCharacterBase_C__pf2132744816*  T__Local__13;
	T__Local__13& bpp__OwningKnight__pf = *const_cast<T__Local__13 *>(&bpp__OwningKnight__pf__const);
	b0l__K2Node_CustomEvent_OwningKnight__pf = bpp__OwningKnight__pf;
	bpf__ExecuteUbergraph_UIHealthBar__pf_0(1);
}
float  UUIHealthBar_C__pf2132744816::bpf__GetPercent_0__pf()
{
	float bpp__ReturnValue__pf{};
	float bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf{};
	float  __Local__14 = 0.000000;
	bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(((::IsValid(bpv__OwningxKnight__pfT)) ? (bpv__OwningxKnight__pfT->bpv__Health__pf) : (__Local__14)), bpv__DefaultHealth__pf);
	bpp__ReturnValue__pf = bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf;
	return bpp__ReturnValue__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void UUIHealthBar_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UUIHealthBar_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{73, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.ProgressBar 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UUIHealthBar_C__pf2132744816
{
	FRegisterHelper__UUIHealthBar_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/UIHealthBar"), &UUIHealthBar_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UUIHealthBar_C__pf2132744816 Instance;
};
FRegisterHelper__UUIHealthBar_C__pf2132744816 FRegisterHelper__UUIHealthBar_C__pf2132744816::Instance;
