...
AKGProjectileBase_C__pf2132744816::AKGProjectileBase_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__FlightSystem__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("FlightSystem"));
	RootComponent = bpv__Sphere__pf;
	bpv__ProjectileMovement__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ProjectileMovement__pf->InitialSpeed = 500.000000f;
	bpv__ProjectileMovement__pf->bShouldBounce = true;
	bpv__ProjectileMovement__pf->ProjectileGravityScale = 0.010000f;
	bpv__ProjectileMovement__pf->Bounciness = 0.800000f;
	...
	__Local__2 = 50.000000f;
	bpv__Sphere__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	bpv__Sphere__pf->SetCollisionProfileName(FName(TEXT("OverlapOnlyPawn")));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Sphere__pf), true, 0));
	bpv__FlightSystem__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__FlightSystem__pf->AttachToComponent(bpv__Sphere__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__FlightSystem__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AKGProjectileBase_C__pf2132744816::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__FlightSystem__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__FlightSystem__pf), false, 0));
...
void AKGProjectileBase_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__FlightSystem__pf)
	{
		bpv__FlightSystem__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AKGProjectileBase_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AKGProjectileBase_C__pf2132744816::bpf__ExecuteUbergraph_KGProjectileBase__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bool bpfv__CallFunc_ApplyRadialDamage_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 6);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AKGProjectileBase_C__pf2132744816::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), true, EPSCPoolMethod::None, true);
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
	if(::IsValid((*(AccessPrivateProperty<APawn* >((this), AActor::__PPO__Instigator() )))))
	{
		bpfv__CallFunc_GetController_ReturnValue_1__pf = (*(AccessPrivateProperty<APawn* >((this), AActor::__PPO__Instigator() )))->APawn::GetController();
	}
	bpfv__CallFunc_ApplyRadialDamage_ReturnValue__pf = UGameplayStatics::ApplyRadialDamage(this, 20.000000, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, 50.000000, ((UClass*)nullptr), b0l__Temp_object_Variable__pf, this, bpfv__CallFunc_GetController_ReturnValue_1__pf, false, ECollisionChannel::ECC_Visibility);
	return; // KCST_GotoReturn
}
void AKGProjectileBase_C__pf2132744816::bpf__ExecuteUbergraph_KGProjectileBase__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf = Cast<AKGCharacterBase_C__pf2132744816>(b0l__K2Node_Event_OtherActor__pf);
		...
		case 3:
			{
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf, (*(AccessPrivateProperty<APawn* >((this), AActor::__PPO__Instigator() ))));
		...
		case 4:
			{
				if(::IsValid((*(AccessPrivateProperty<APawn* >((this), AActor::__PPO__Instigator() )))))
				{
					bpfv__CallFunc_GetController_ReturnValue__pf = (*(AccessPrivateProperty<APawn* >((this), AActor::__PPO__Instigator() )))->APawn::GetController();
				}
				bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_DynamicCast_AsKGCharacter_Base__pf, 50.000000, bpfv__CallFunc_GetController_ReturnValue__pf, this, ((UClass*)nullptr));
			}
		case 5:
			{
				K2_DestroyActor();
...
void AKGProjectileBase_C__pf2132744816::bpf__ReceiveDestroyed__pf()
{
	bpf__ExecuteUbergraph_KGProjectileBase__pf_0(6);
}
void AKGProjectileBase_C__pf2132744816::bpf__ReceiveActorBeginOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_KGProjectileBase__pf_1(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void AKGProjectileBase_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AKGProjectileBase_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{70, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.ProjectileMovementComponent 
		{49, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.SphereComponent 
		...
		{47, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.ParticleSystemComponent 
		...
		{14, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Actor 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AKGProjectileBase_C__pf2132744816
{
	FRegisterHelper__AKGProjectileBase_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/KGProjectileBase"), &AKGProjectileBase_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AKGProjectileBase_C__pf2132744816 Instance;
};
FRegisterHelper__AKGProjectileBase_C__pf2132744816 FRegisterHelper__AKGProjectileBase_C__pf2132744816::Instance;
